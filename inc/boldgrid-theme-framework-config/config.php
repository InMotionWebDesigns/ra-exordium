...
function boldgrid_theme_framework_config( $boldgrid_framework_configs ) {
	 ...
	 * General Configs
	 */
	$boldgrid_framework_configs['theme_name'] = 'ra-exordium';
	...
	// Typography Headings.
	$boldgrid_framework_configs['customizer-options']['typography']['defaults']['headings_font_family'] = 'Source Sans Pro';
	...
	$boldgrid_framework_configs['customizer-options']['typography']['defaults']['alternate_headings_font_family'] = 'Source Sans Pro';
	...
	$boldgrid_framework_configs['customizer-options']['typography']['defaults']['navigation_font_family'] = 'Source Sans Pro';
	...
	// Typography Body.
	$boldgrid_framework_configs['customizer-options']['typography']['defaults']['body_font_family'] = 'Source Sans Pro';
...
function filter_logo_controls( $controls ) {
	$controls['logo_font_family']['default'] = 'Source Sans Pro';
